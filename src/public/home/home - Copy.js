            ...
            <div id='home_app_bdy_coont_top_cont'>
                        ...
                        <div id="home_app_bdy_top_right_cont">
                        {
                            this.state.isLogged?
                                    this.state.windowWidth>650?
                                    <span>
                                        <div id='home_app_bdy_cont_left_cont_upl_cont'><button id='home_app_bdy_cont_left_cont_upl_butt'  onClick={() => { this.setState({ postModalVisi: !this.state.isDark }) }}>Post</button></div>
