    ...
    render(){
        ...
        <div id='home_app_bdy_cont' style={themeColor}>
                <div id='home_app_bdy_left_cont'>                    
                               ...
                               <div className='home_app_bdy_order_cont'>
                                <div className='home_app_bdy_order_cont_tit'>Orders</div>
                                    <div className='home_app_bdy_order_make_cont'>
                                            <a href='#' className='home_app_bdy_order_make_cont_lnk'><svg className='home_app_left_bdy_ico'      viewBox='0 0 512 512'><title>Add Circle</title><path d='M448 256c0-106-86-192-192-192S64 150 64 256s86 192 192 192 192-86 192-192z' fill='none' stroke='currentColor' stroke-miterlimit='10' stroke-width='32'/><path fill='none' stroke='currentColor' stroke-linecap='round' stroke-linejoin='round' stroke-width='32' d='M256 176v160M336 256H176'/></svg>New Order</a>
                                    </div>    
                               </div>
                               ...
                               <div className='home_app_bdy_order_cont'>
                               <div className='home_app_bdy_order_opt_bdy'> 
                                                          <a href='#' className='home_app_bdy_cost_cal_opt_bdy_lnk'><svg className='home_app_left_bdy_ico'  viewBox='0 0 512 512'><title>Wallet</title><rect x='48' y='144' width='416' height='288' rx='48' ry='48' fill='none' stroke='currentColor' stroke-linejoin='round' stroke-width='22'/><path d='M411.36 144v-30A50 50 0 00352 64.9L88.64 109.85A50 50 0 0048 159v49' fill='none' stroke='currentColor' stroke-linejoin='round' stroke-width='22'/><path fill='currentColor' stroke='currentColor'  d='M368 320a32 32 0 1132-32 32 32 0 01-32 32z'/></svg>Cost Callculator</a>
                                                    </div>
                                   
                               </div>
                </div>
                <div id='home_app_bdy_cent_cont'>
                    <Routers onChangeSite={(i)=>{this.setState({currSite:i})}}/>
                </div>
        </div>);
    }
}