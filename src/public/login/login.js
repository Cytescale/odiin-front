...
export default class LoginClass extends React.Component{
    ...
    render(){
        ...
        axios("http://172.20.10.3:8080/getdata",{ // you may send any data, encoded as you wish. shall match content-type 
        ...
        return (
            ...
            <div className='login_frm_cont'>
                  ...
                  <div className='l_f_c_tt'id='l_f_c_u_f'><input type="text" className="form-control" id='login_unm_txt' placeholder=" " aria-label="username" name='username' aria-describedby="basic-addon1"></input></div>
                  <div className='l_f_c_e' id='l_f_c_p_c'>Password</div>
                  <div className='l_f_c_tt'id='l_f_c_p_f'><input type="password" className="form-control" id='login_pass_txt' placeholder=" " aria-label="password" name='password' aria-describedby="basic-addon1"></input></div>
